...
var server = http.createServer(function (req, res) {
  ...
  } else if (req.url.startsWith("/addition") && req.method == "POST") {
    // Access URL-encoded form data from body, then calculate, then write response
    fileHandler(req, res, "addition.html");
    let data = "";
